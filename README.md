...
| WAV | RIFF/WAVE chunks, `fmt ` audio properties, `LIST/INFO`, Broadcast Wave `bext`, bounded iXML XML leaves and packet retention, and bounded validation |
