...
Le créateur AVI ajoute désormais un seed 1x1 DIB borné avec `LIST/INFO`, validation de sortie et refus d’écrasement ; l’encodage vidéo général et la création arbitraire de chunks restent planifiés.
