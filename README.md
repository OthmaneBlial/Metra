...
strings and preserve the EBML layout; the replacement must fit its existing
payload.
TIFF-like RAW edits target an existing TIFF/BigTIFF ASCII slot; DNG, CR2, NEF,
ARW, ORF, RW2, and PEF are supported. CR3 edits target existing ISO-BMFF text
