...
2,536 Metra tags compared to the oracle, 1,280 stable-key matches, and 1,057
typed-value matches. The corpus axis remains conservative because 124 files
...
2. **45 %** — Ajouter des corpus réels et des tests différentiels JPEG/TIFF/PNG/WebP ; le harnais opt-in a été exécuté sur un corpus local de 194 fichiers sans panic, avec 70 fichiers reconnus, 1 280 clés et 1 057 valeurs typées alignées, mais 124 fichiers restent hors surface et aucune preuve n’est embarquée dans le dépôt.
