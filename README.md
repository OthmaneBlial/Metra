...
Generic writing, creation, PSD/PSB/RAW/MKV/WebM writing, MakerNote tag
interpretation beyond the bounded Nikon Type 1/2, Canon, Fujifilm, Panasonic, Olympus, legacy Sony, and Apple IFD fields, and full media and
...
deferred.
MakerNotes remain partial outside the bounded Nikon Type 1/2, Canon, Fujifilm, Panasonic, Olympus, legacy Sony, Apple, Samsung STMN, and DJI fields; GoPro is currently detection-only; MP3/ID3,
...
3,199 Metra tags compared to the oracle, 1,837 stable-key matches, and 1,417
