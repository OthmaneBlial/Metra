...
| AVI | RIFF/AVI validation, bounded `avih` dimensions and frame timing, `strh` stream type/codec/rate/duration/frame bounds, and common `LIST/INFO` text fields without decoding video frames |
...
2,974 Metra tags compared to the oracle, 1,837 stable-key matches, and 1,416
