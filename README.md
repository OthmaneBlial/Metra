...
deferred.
MakerNotes remain partial outside the bounded Nikon Type 1/2, Canon, Fujifilm, Panasonic, Olympus, legacy Sony, Apple, and Samsung STMN fields; DJI and GoPro are currently detection-only; MP3/ID3,
...
Olympus, legacy Sony, and Apple readers, deeper media metadata support, and a generalized
