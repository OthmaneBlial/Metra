...
| FLAC | `STREAMINFO`, bounded `SEEKTABLE` seek-point structures, Vorbis comments, embedded-picture properties/data, and bounded metadata-block validation |
