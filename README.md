...
| TIFF/EXIF | Little- and big-endian classic TIFF and BigTIFF headers, 64-bit IFD counts/offsets, nested EXIF/GPS/Interop directories, bounded multiple `SubIFD` offsets, chained IFD0/IFD1/IFD2 thumbnail directories, common image/exposure/lens tag names, rational values, ASCII/Unicode `UserComment`, common MakerNote container detection with bounded Nikon Type 2, Canon, Fujifilm, Panasonic, Olympus, and legacy Sony IFD fields, retained unknown MakerNote values, unknown tags, thumbnail range checks, and validated decimal GPS latitude/longitude, altitude, direction, time, and speed helpers |
...
interpretation beyond the bounded Nikon Type 2, Canon, Fujifilm, Panasonic, Olympus, and legacy Sony IFD fields, and full media and
...
MakerNotes remain partial outside the bounded Nikon Type 2, Canon, Fujifilm, Panasonic, Olympus, and legacy Sony IFD fields; MP3/ID3,
...
Nikon Type 2, Canon, Fujifilm, Panasonic, Olympus, and legacy Sony readers, deeper media
...
3,099 Metra tags compared to the oracle, 1,837 stable-key matches, and 1,416
