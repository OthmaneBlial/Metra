...
mod tests {
    ...
    fn format_capability_matrix_matches_current_writer_surface() {
        ...
        for format in [
            ...
            assert_eq!(
                format_capabilities(format).delete,
                CapabilityStatus::Partial
            );
        }
        assert_eq!(
        ...
        assert_eq!(
            format_capabilities(FileFormat::Xmp).write,
            CapabilityStatus::Partial
        );
        assert_eq!(
            format_capabilities(FileFormat::Xmp).lossless_rewrite,
            CapabilityStatus::Partial
        );
        assert_eq!(
        ...
        assert_eq!(
            format_capabilities(FileFormat::Webp).create,
            CapabilityStatus::Partial
        );
        assert_eq!(
        ...
        assert_eq!(
            format_capabilities(FileFormat::Psd).delete,
            CapabilityStatus::Partial
        );
        assert_eq!(
        ...
        assert_eq!(
            format_capabilities(FileFormat::Mp4).create,
            CapabilityStatus::Partial
        );
        assert_eq!(
            format_capabilities(FileFormat::Mov).create,
            CapabilityStatus::Partial
        );
        assert_eq!(
            format_capabilities(FileFormat::M4a).create,
            CapabilityStatus::Partial
        );
        assert_eq!(
            format_capabilities(FileFormat::Heif).create,
            CapabilityStatus::Partial
        );
        assert_eq!(
            format_capabilities(FileFormat::Avif).create,
            CapabilityStatus::Partial
        );
